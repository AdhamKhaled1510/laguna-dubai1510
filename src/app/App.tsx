...
const menuData: MenuItemType[] = [
  ...
  { id: 303, name: 'Fruit Tea',                  nameAr: 'شاي فواكة',             descriptionAr: 'شاي بالفواكه الطازجة',             price: 35, image: IMG_CAPPUCCINO, category: 'hot' },
  { id: 304, name: 'Complete Tea',               nameAr: 'شاي كومبليت',           descriptionAr: 'شاي كومبليت مميز',                 price: 45, image: IMG_CAPPUCCINO, category: 'hot' },
  { id: 305, name: 'Ginger',                     nameAr: 'جنزبيل',               descriptionAr: 'جنزبيل ساخن طازج',                 price: 25, image: IMG_CAPPUCCINO, category: 'hot' },
  { id: 306, name: 'Hot Cider',                  nameAr: 'هوت سيدر',             descriptionAr: 'سيدر ساخن بالقرفة',                price: 35, image: IMG_CAPPUCCINO, category: 'hot' },
  { id: 307, name: 'Hot Caramel',                nameAr: 'هوت كاراميل',          descriptionAr: 'مشروب كراميل ساخن',                price: 50, image: IMG_CAPPUCCINO, category: 'hot' },
  { id: 308, name: 'Hot Nutella',                nameAr: 'هوت نوتيلا',           descriptionAr: 'نوتيلا ساخنة كريمية',               price: 55, image: IMG_CAPPUCCINO, category: 'hot' },
  { id: 309, name: 'Hot Marshmallow',            nameAr: 'هوت مارشملو',          descriptionAr: 'مشروب مارشملو ساخن',               price: 50, image: IMG_CAPPUCCINO, category: 'hot' },
  { id: 310, name: 'Hot Oreo',                   nameAr: 'هوت اوريو',            descriptionAr: 'مشروب أوريو ساخن',                 price: 55, image: IMG_CAPPUCCINO, category: 'hot' },
  { id: 311, name: 'Iced White Mocha',           nameAr: 'ايس موكا وايت',        descriptionAr: 'موكا أبيض بارد',                   price: 75, image: IMG_ICED,      category: 'iced' },
  { id: 312, name: 'Iced Flavored Latte',        nameAr: 'ايس لاتيه فليفر',      descriptionAr: 'لاتيه بارد بنكهات',                price: 70, image: IMG_ICED,      category: 'iced' },
  { id: 313, name: 'Date Juice',                 nameAr: 'عصير بلح',             descriptionAr: 'عصير بلح طازج',                    price: 65, image: IMG_JUICE,     category: 'juices' },
  { id: 314, name: 'Delight Punch',              nameAr: 'كوكتيل ديلايت بانش',   descriptionAr: 'كوكتيل ديلايت بانش',               price: 85, image: IMG_COCKTAIL,  category: 'cocktails' },
  { id: 315, name: 'Timara',                     nameAr: 'كوكتيل تيمارا',        descriptionAr: 'كوكتيل تيمارا',                    price: 85, image: IMG_COCKTAIL,  category: 'cocktails' },
  { id: 316, name: 'Dabomba',                    nameAr: 'كوكتيل دابومبا',        descriptionAr: 'كوكتيل دابومبا',                    price: 85, image: IMG_COCKTAIL,  category: 'cocktails' },
  { id: 317, name: 'Shahrazad',                  nameAr: 'كوكتيل شهر زاد',       descriptionAr: 'كوكتيل شهر زاد',                   price: 90, image: IMG_COCKTAIL,  category: 'cocktails' },
  { id: 318, name: 'La Rose',                    nameAr: 'كوكتيل لاروز',         descriptionAr: 'كوكتيل لاروز',                     price: 85, image: IMG_COCKTAIL,  category: 'cocktails' },
  { id: 319, name: 'Green Apple Smoothie',       nameAr: 'اسموزي تفاح اخضر',     descriptionAr: 'سموزي تفاح أخضر',                  price: 60, image: IMG_SMOOTHIE,  category: 'smoothie' },
  { id: 320, name: 'Pineapple Smoothie',         nameAr: 'اسموزي اناناس',        descriptionAr: 'سموزي أناناس',                     price: 60, image: IMG_SMOOTHIE,  category: 'smoothie' },
  { id: 321, name: 'Peach Smoothie',             nameAr: 'اسموزي خوخ',           descriptionAr: 'سموزي خوخ',                       price: 60, image: IMG_SMOOTHIE,  category: 'smoothie' },
  { id: 322, name: 'Berry Mojito',               nameAr: 'موهيتو توت',           descriptionAr: 'موهيتو بالتوت',                    price: 65, image: IMG_MOJITO,    category: 'mojito' },
  { id: 323, name: 'Passion Fruit Mojito',       nameAr: 'موهيتو باشون فروت',    descriptionAr: 'موهيتو باشون فروت',                price: 65, image: IMG_MOJITO,    category: 'mojito' },
  { id: 324, name: 'Barley Mojito',              nameAr: 'موهيتو شعير',          descriptionAr: 'موهيتو بالشعير',                   price: 60, image: IMG_MOJITO,    category: 'mojito' },
  { id: 325, name: 'Cherry Cola Mojito',         nameAr: 'موهيتو شيري كولا',     descriptionAr: 'موهيتو شيري كولا',                 price: 70, image: IMG_MOJITO,    category: 'mojito' },
  { id: 326, name: 'Power Soda',                 nameAr: 'باور صودا',            descriptionAr: 'باور صودا',                        price: 55, image: IMG_MOJITO,    category: 'mojito' },
  { id: 327, name: 'White Nutella Brownie Shake', nameAr: 'ميلك شيك وايت نوتيلا براوني', descriptionAr: 'ميلك شيك نوتيلا براوني',  price: 100, image: IMG_SHAKE,     category: 'milkshake' },
  { id: 328, name: 'Passion Fruit Shake',        nameAr: 'ميلك شيك باشون فروت',  descriptionAr: 'ميلك شيك باشون فروت',              price: 80, image: IMG_SHAKE,     category: 'milkshake' },
  { id: 329, name: 'Classic Yogurt',             nameAr: 'زبادي كلاسيك',         descriptionAr: 'زبادي كلاسيك',                     price: 50, image: IMG_YOGURT,    category: 'yogurt' },
  { id: 330, name: 'Strawberry Yogurt',          nameAr: 'زبادي فراوله',         descriptionAr: 'زبادي بالفراولة',                  price: 55, image: IMG_YOGURT,    category: 'yogurt' },
  { id: 331, name: 'Mixed Fruit Yogurt',         nameAr: 'زبادي مكس فواكه',      descriptionAr: 'زبادي بمكس الفواكه',               price: 65, image: IMG_YOGURT,    category: 'yogurt' },
  { id: 332, name: 'Mango Yogurt',               nameAr: 'زبادي مانجو',          descriptionAr: 'زبادي بالمانجو',                   price: 55, image: IMG_YOGURT,    category: 'yogurt' },
  { id: 333, name: 'Honey Banana Yogurt',        nameAr: 'زبادي موز عسل',        descriptionAr: 'زبادي بالموز والعسل',              price: 65, image: IMG_YOGURT,    category: 'yogurt' },
  { id: 334, name: 'Passion Fruit Yogurt',       nameAr: 'زبادي باشون فروت',     descriptionAr: 'زبادي باشون فروت',                 price: 60, image: IMG_YOGURT,    category: 'yogurt' },
  { id: 335, name: 'Dark Waffle',                nameAr: 'وافل دارك',            descriptionAr: 'وافل بالشوكولاتة الداكنة',         price: 55, image: IMG_DESSERT,   category: 'dessert' },
  { id: 336, name: 'Lotus Waffle',               nameAr: 'وافل لوتس',            descriptionAr: 'وافل ببسكويت اللوتس',             price: 60, image: IMG_DESSERT,   category: 'dessert' },
  { id: 337, name: 'White Waffle',               nameAr: 'وافل وايت',            descriptionAr: 'وافل بالشوكولاتة البيضاء',         price: 55, image: IMG_DESSERT,   category: 'dessert' },
  { id: 338, name: 'Nutella Waffle',             nameAr: 'وافل نوتيلا',          descriptionAr: 'وافل بالنوتيلا',                   price: 60, image: IMG_DESSERT,   category: 'dessert' },
  { id: 339, name: 'Oreo Waffle',                nameAr: 'وافل اوريو',           descriptionAr: 'وافل بالأوريو',                    price: 60, image: IMG_DESSERT,   category: 'dessert' },
  { id: 340, name: 'Waffle Ice Cream & Banana',  nameAr: 'وافل ايس كريم & موز',  descriptionAr: 'وافل بالايس كريم والموز',          price: 70, image: IMG_DESSERT,   category: 'dessert' },
  { id: 341, name: 'Molten Cake',                nameAr: 'مولتن كيك',            descriptionAr: 'مولتن كيك بالشوكولاتة',            price: 65, image: IMG_DESSERT,   category: 'dessert' },
  { id: 342, name: 'Nutella Cinnamon Roll',      nameAr: 'سينابون نوتيلا',       descriptionAr: 'سينابون بالنوتيلا',                price: 55, image: IMG_DESSERT,   category: 'dessert' },
  { id: 343, name: 'Cinnamon Roll',              nameAr: 'سينابون',              descriptionAr: 'سينابون كلاسيك',                   price: 45, image: IMG_DESSERT,   category: 'dessert' },
  { id: 344, name: 'Molten Cake Ice Cream',      nameAr: 'مولتن ايس كريم',       descriptionAr: 'مولتن كيك بالايس كريم',            price: 75, image: IMG_DESSERT,   category: 'dessert' },
  { id: 345, name: 'Brownies',                   nameAr: 'براونيز',              descriptionAr: 'براونيز بالشوكولاتة',              price: 45, image: IMG_DESSERT,   category: 'dessert' },
  { id: 346, name: 'Fruit Salad',                nameAr: 'فروت سالط',            descriptionAr: 'فروت سالط طازج',                   price: 50, image: IMG_DESSERT,   category: 'dessert' },
  { id: 347, name: 'Fruit Salad with Ice Cream',  nameAr: 'فروت سالط ايس كريم',  descriptionAr: 'فروت سالط بالايس كريم',            price: 65, image: IMG_DESSERT,   category: 'dessert' },
  { id: 348, name: 'Fruit Salad with Nuts & Ice Cream', nameAr: 'فروت سالط مكسرات ايس كريم', descriptionAr: 'فروت سالط بالمكسرات والايس كريم', price: 75, image: IMG_DESSERT,   category: 'dessert' },
].map(item => ({
  ...item,
